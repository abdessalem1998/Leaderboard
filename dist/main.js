...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _apiCommunication_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./apiCommunication.js */ \"./src/apiCommunication.js\");\n/* harmony import */ var _display_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./display.js */ \"./src/display.js\");\n\n\n\n\n// create the game setting\nlet gameId = 'Still loading';\nconst url = 'https://us-central1-js-capstone-backend.cloudfunctions.net/api/games/';\nconst gameName = 'dib Game v-1.0';\n\n// int the game\n(0,_apiCommunication_js__WEBPACK_IMPORTED_MODULE_1__.gameInt)(url, gameName).then((response) => {\n  gameId = response;\n});\n\nconst appCore = () => {\n  // refresh action\n  const refresh = document.getElementById('refresh');\n  refresh.addEventListener('click', () => {\n    (0,_apiCommunication_js__WEBPACK_IMPORTED_MODULE_1__.fetchData)(url, gameId).then((response) => {\n      (0,_display_js__WEBPACK_IMPORTED_MODULE_2__.display)(response);\n    });\n  });\n\n  // submit action\n  const submit = document.getElementById('submit');\n  submit.addEventListener('click', () => {\n    document.getElementById('notify').classList.remove('hide');\n    (0,_apiCommunication_js__WEBPACK_IMPORTED_MODULE_1__.submitData)(url, gameId);\n    setTimeout(_display_js__WEBPACK_IMPORTED_MODULE_2__.removeNotify, 3000);\n  });\n};\n\n// run the game\nappCore();\n\n\n//# sourceURL=webpack://leaderboard/./src/index.js?");
